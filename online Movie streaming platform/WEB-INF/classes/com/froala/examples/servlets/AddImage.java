...
public class AddImage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String uploadPath="/Users/udeesharukshan/eclipse-workspace/aftererror/src/main/webapp/Images/"+imageFileName;  // upload path where we have to upload our actual image
